 ...
 * ================================================
 */
public class MyMiExToast implements View.OnTouchListener {
    ...
    public MyMiExToast(Context context){
        ...
        mView = inflate.inflate(R.layout.item_tips_goal, null);
    ...
    public void show(){
        if (isShow) return;
        initTN();
        TextView tv = (TextView)mView.findViewById(R.id.home_team_name);
        tv.setText("悬浮窗");
        toast.setView(mView);
//        initTN();
        try {
    ...
    public static MyMiExToast makeText(Context context, CharSequence text, int duration) {
        Toast toast = Toast.makeText(context,text,Toast.LENGTH_SHORT);
        MyMiExToast exToast = new MyMiExToast(context);
        exToast.toast = toast;
    ...
    public static MyMiExToast makeText(Context context, int resId, int duration)
