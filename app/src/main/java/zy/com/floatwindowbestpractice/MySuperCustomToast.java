 ...
 */
public class MySuperCustomToast {
    /**
     * 获取当前Android系统版本
     */
     ...
     * 单例
     */
    private static MySuperCustomToast instance;
     ...
     * @return
     */
    public static MySuperCustomToast getInstance(Context context) {
        if (instance == null) {
            instance = new MySuperCustomToast(context);
        }
        return instance;
    }

    private MySuperCustomToast(Context context) {
    ...
    public void initView() {
        ...
        gapView.setLayoutParams(new LayoutParams(screenWidth, screenHeight / 10));
    ...
    public void showGoal(List<EventBean> list, final Context context, final Activity activity) {
        layout = LayoutInflater.from(context).inflate(R.layout.item_tips_goal, null);
        lp_WW = new LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT);
...
//        MyAdapter adapter;
//        layout = LayoutInflater.from(context).inflate(R.layout.item_tips_recycler, null);
...
//        });
    ...
    private void initTN() {
        ...
        } catch (NoSuchFieldException | IllegalAccessException | IllegalArgumentException | NoSuchMethodException e) {
    ...
    private void showToast() {
        try {
            ...
            if (currentApiVersion > 10) {
                Field tnParamsField = mObj.getClass().getDeclaredField("mParams");
                tnParamsField.setAccessible(true);
                WindowManager.LayoutParams params = (WindowManager.LayoutParams) tnParamsField.get(mObj);
